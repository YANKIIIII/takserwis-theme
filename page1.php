...
.grid-bonus__content ol {list-style: decimal; margin-left:15px; margin-bottom:10px;}
.grid-bonus__content ul {list-style: disc; margin-left:15px; margin-bottom:10px;}

h2 {font-size:24px}
.grid-bonus__content li,
.grid-bonus__content p {
  font-size: 16px;
  line-height: 165%;
}
</style>
