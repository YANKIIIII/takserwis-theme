    ...
    if (!ariaLabel) {
      if (placeholder) {
        ...
        if (name) {
          ...
          if (name.includes('menu-88')) friendlyName = 'Wybór usługi';else if (name.includes('menu-89')) friendlyName = 'Wybór konkretnej usługi';else if (name.includes('your-name')) friendlyName = 'Twoje imię i nazwisko';else if (name.includes('tel-351')) friendlyName = 'Numer telefonu';else if (name.includes('your-message')) friendlyName = 'Dodatkowe informacje';
