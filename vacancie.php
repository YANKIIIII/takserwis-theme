...
<style>
/* 
    Unique Przegląd Techniczny Styles 
    Diverging from Corporate Client layout for the Hero section.
*/
...
.skp-hero-image-wrapper img {
    width: 100%;
    height: 93.5%;
    border-radius: 24px;
    object-fit: cover;
    box-shadow: 0 20px 40px rgba(0, 0, 0, 0.08); /* Soft, elegant shadow */
}
...
/* New Block with SEO Text */
.skp-seo-text-block {
    width: 100%;
    background: #f4f6f8;
    border-left: 4px solid #ff9d42;
    padding: 24px 30px;
    border-radius: 12px;
}

.skp-seo-text-block p {
    color: rgba(26, 25, 36, 0.8);
    font-size: 16px;
    line-height: 1.7;
    margin: 0;
}
...
/* Expanded SEO block */
.skp-seo-expanded-block {
    padding: 20px 0 60px 0;
    color: rgba(26,25,36,0.7);
    line-height: 1.8;
}
.skp-seo-expanded-block .header_section div { font-size: 15px; }
.skp-seo-expanded-block strong { color: #1a1924; font-weight: 600; }
...
.skp-benefit-card {
    ...
    padding: 35px 30px;
    border-radius: 16px;
    box-shadow: 0 10px 20px rgba(26, 25, 36, 0.04);
}
...
.skp-benefit-card p {
    color: rgba(26, 25, 36, 0.6);
    font-size: 15px;
    line-height: 1.5;
    margin: 0;
}

/* Base Rest of Page (Keeping corporate-like vibe for the rest per previous request) */
.skp-services-block {
    background-color: #ffffff;
    padding: 100px 0;
}
...
@media (max-width: 1024px) {
    .skp-grid { grid-template-columns: repeat(2, 1fr); }
}
...
.skp-grid-item:hover h4, 
.skp-grid-item:hover p {
    color: #ffffff;
}

.skp-grid-icon-holder {
...
.skp-grid-item:hover .skp-grid-icon-holder {
    background: #ff9d42;
    color: #fff;
}
...
.skp-accordion-header {
    ...
    font-size: 18px; font-weight: 700; color: #1a1924;
...
.skp-accordion-content p {
    padding: 0 30px 25px 30px; color: rgba(26,25,36,0.7); line-height: 1.6;
}

/* Contact form matching Front Page */
.skp-form-vertical {
    display: flex;
    flex-direction: column;
    gap: 15px;
...
.skp-form-vertical input,
.skp-form-vertical select {
    width: 100%;
    height: 54px;
    padding: 14px 20px;
    border: none;
...
.skp-form-vertical button:hover {
    background: #e88931;
}
...
.skp-hours-banner {
    ...
    gap: 18px;
    background: linear-gradient(135deg, #1a1924 0%, #2a2940 100%);
    border-radius: 16px;
    padding: 28px 32px;
    margin-bottom: 25px;
    color: #ffffff;
    box-shadow: 0 8px 24px rgba(26, 25, 36, 0.15);
}
.skp-hours-icon {
    flex-shrink: 0;
    width: 48px;
...
.skp-hours-list li:last-child {
    border-bottom: none;
    margin-bottom: 0;
    padding-bottom: 0;
}
.skp-hours-list li.closed {
    color: rgba(255, 255, 255, 0.4);
}
.skp-hours-list li span:last-child {
    font-weight: 600;
    color: #ff9d42;
}
.skp-hours-list li.closed span:last-child {
    color: rgba(255, 255, 255, 0.4);
}
@media (max-width: 600px) {
    .skp-hours-banner {
...
<div class="skp-module-container">
    ...
    <section class="skp-hero-unique">
        <div class="container">
            ...
            <p class="skp-hero-subtitle" style="font-size: 20px; font-weight: 500; color: rgba(26,25,36,0.7); margin-top: -15px; margin-bottom: 30px;">Warszawska 39/41, 61-028 Poznań</p>
            <div class="skp-hero-unique-inner">
                
                <div class="skp-hero-content">
                    <div class="skp-hours-banner">
                        <div class="skp-hours-icon">
                            <svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                        </div>
                        <div class="skp-hours-content">
                            <div class="skp-hours-title">Часы работы</div>
                            <div class="skp-hours-grid">
                                <div class="skp-hours-item">
                                    <span class="skp-hours-label" style="font-size: 14px; color: #fff; margin-bottom: 12px; font-weight: 600;">Запись по телефону</span>
                                    <ul class="skp-hours-list">
                                        <li><span>Понедельник</span><span>8:30 – 17:00</span></li>
                                        <li><span>Вторник</span><span>8:30 – 17:00</span></li>
                                        <li><span>Среда</span><span>8:30 – 17:00</span></li>
                                        <li><span>Четверг</span><span>8:30 – 17:00</span></li>
                                        <li><span>Пятница</span><span>8:30 – 17:00</span></li>
                                        <li class="closed"><span>Суббота</span><span>Выходной</span></li>
                                        <li class="closed"><span>Воскресенье</span><span>Выходной</span></li>
                                    </ul>
                                </div>
                                <div class="skp-hours-item">
                                    <span class="skp-hours-label" style="font-size: 14px; color: #fff; margin-bottom: 12px; font-weight: 600;">Проведение осмотра</span>
                                    <ul class="skp-hours-list">
                                        <li><span>Понедельник</span><span>8:00 – 19:00</span></li>
                                        <li><span>Вторник</span><span>8:00 – 19:00</span></li>
                                        <li><span>Среда</span><span>8:00 – 19:00</span></li>
                                        <li><span>Четверг</span><span>8:00 – 19:00</span></li>
                                        <li><span>Пятница</span><span>8:00 – 19:00</span></li>
                                        <li><span>Суббота</span><span>8:00 – 19:00</span></li>
                                        <li class="closed"><span>Воскресенье</span><span>Выходной</span></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="skp-hero-actions">
                    <a href="tel:+48664040599" class="button contrast" style="text-transform: none;">Запишитесь на ТО</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="skp-benefits-grid">
                ...
                <div class="skp-benefit-card">
                    ...
                    <p><strong>Техосмотр автомобиля</strong> находится в черте города, рядом с крупной транспортной развязкой – <strong>Rondo Śródka</strong>.</p>
                </div>
    ...
    <section class="skp-services-block">
        <div class="container">
            <div class="header_section text_left">
                <h2>Что включает в себя процедура осмотра?</h2>
            ...
            <div class="skp-grid">
                <div class="skp-grid-item">
                    <div class="skp-grid-icon-holder"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="22" y1="12" x2="18" y2="12"></line><line x1="6" y1="12" x2="2" y2="12"></line><line x1="12" y1="6" x2="12" y2="2"></line><line x1="12" y1="22" x2="12" y2="18"></line></svg></div>
                    <h4>Проверка ходовой части </h4>
                ...
                <div class="skp-grid-item">
                    ...
                    <h4>Проверка тормозной системы</h4>
                ...
                <div class="skp-grid-item">
                    <div class="skp-grid-icon-holder"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.9 1.2 1.5 1.5 2.5"/><path d="M9 18h6"/><path d="M10 22h4"/></svg></div>
                ...
                <div class="skp-grid-item">
                    <div class="skp-grid-icon-holder"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.59 4.59A2 2 0 1 1 11 8H2m10.59 11.41A2 2 0 1 0 14 16H2m15.73-8.27A2.5 2.5 0 1 1 19.5 12H2"></path></svg></div>
            ...
            <div class="skp-hero-unique-inner">
                ...
                <div class="skp-hero-content">
                    <div class="skp-hours-banner">
                        ...
                        <div class="skp-hours-content">
                            <div class="skp-hours-title">Godziny pracy</div>
                            <div class="skp-hours-grid">
                                <div class="skp-hours-item">
                                    <span class="skp-hours-label" style="font-size: 14px; color: #fff; margin-bottom: 12px; font-weight: 600;">Rejestracja telefoniczna</span>
                                    <ul class="skp-hours-list">
                                        <li><span>Poniedziałek</span><span>8:30 – 17:00</span></li>
                                        <li><span>Wtorek</span><span>8:30 – 17:00</span></li>
                                        <li><span>Środa</span><span>8:30 – 17:00</span></li>
                                        <li><span>Czwartek</span><span>8:30 – 17:00</span></li>
                                        <li><span>Piątek</span><span>8:30 – 17:00</span></li>
                                        <li class="closed"><span>Sobota</span><span>Zamknięte</span></li>
                                        <li class="closed"><span>Niedziela</span><span>Zamknięte</span></li>
                                    </ul>
                                </div>
                                <div class="skp-hours-item">
                                    <span class="skp-hours-label" style="font-size: 14px; color: #fff; margin-bottom: 12px; font-weight: 600;">Przegląd techniczny</span>
                                    <ul class="skp-hours-list">
                                        <li><span>Poniedziałek</span><span>8:00 – 19:00</span></li>
                                        <li><span>Wtorek</span><span>8:00 – 19:00</span></li>
                                        <li><span>Środa</span><span>8:00 – 19:00</span></li>
                                        <li><span>Czwartek</span><span>8:00 – 19:00</span></li>
                                        <li><span>Piątek</span><span>8:00 – 19:00</span></li>
                                        <li><span>Sobota</span><span>8:00 – 19:00</span></li>
                                        <li class="closed"><span>Niedziela</span><span>Zamknięte</span></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="skp-hero-actions">
                    <a href="tel:+48880353599" class="button contrast" style="text-transform: none;">Umów się na wizytę</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="skp-services-block">
        <div class="container">
            <div class="header_section text_left">
                <h2>Czym charakteryzuje się nasze badanie?</h2>
            ...
            <div class="skp-grid">
                ...
                <div class="skp-grid-item">
                    <div class="skp-grid-icon-holder"><svg viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"></polygon><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg></div>
                    <h4>Kontrola układu hamulcowego</h4>
