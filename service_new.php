...
/* Desktop Styles */
  ...
  /* Стили для двух самых нижних service-item (на десктопе) */
  .service-prices .service-list .service-item:nth-last-child(2),
  .service-prices .service-list .service-item:nth-last-child(1) {
  ...
  @media (max-width: 768px) { /* Adjust breakpoint as needed */
    ...
    .service-prices .header {
      ...
      text-align: left; /* Re-align text to left for mobile */
    }

    .service-prices .header {
      border-radius: 8px; /* Add border-radius to header in mobile */
      border-bottom-left-radius: 0;
      border-bottom-right-radius: 0;
    }

    /* Remove styling for second header */
    .service-prices .service-list .header:nth-of-type(2) {
      display: none;
    }

    .service-prices .service-item {
      display: flex; /* Use flexbox for service items */
      justify-content: space-between; /* Distribute service name and price */
      align-items: center;
    }
      /* Стили для двух самых нижних service-item (на десктопе) */
  .service-prices .service-list .service-item:nth-last-child(2) {
